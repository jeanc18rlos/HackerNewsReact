...
const CodingHeader = props => {
    return <article style={{textAlign:"center",display:"flex",height:"100%",width:"100%"}}>
    <pre>קסעסאָקסס עפשער דער בעסטער בלאָג אין Spanish קסס קסס פאַרקויפער זאָגן ענרעדיקווע אַ מאָדערן וועבזייַטל פֿאַר טאַסטעפוללי אַרגינאַוטאַס</pre>
